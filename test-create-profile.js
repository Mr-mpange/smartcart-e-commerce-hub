...
const SUPABASE_SERVICE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFwb2p6Ymxib2RscGh3emZweGJpIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MzMxNTA4MSwiZXhwIjoyMDg4ODkxMDgxfQ.Yd0Yd0Yd0Yd0Yd0Yd0Yd0Yd0Yd0Yd0Yd0Yd0Yd0';
...
async function run() {
  ...
  if (success) {
    ...
    console.log('   2. Login with: kilindosaid771@gmail.com / 11111111');
    console.log('   3. You should see the Vendor Dashboard');
    console.log('   4. Look for "Payment Collection" section');
    console.log('   5. Click "Create Payment Link"');
  }
}
