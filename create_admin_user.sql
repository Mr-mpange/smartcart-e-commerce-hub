...
-- This script creates an admin user with email admin@test.com and phone +255683859574
...
BEGIN
    ...
    ELSE
        ...
        RAISE NOTICE 'Found existing user admin@test.com with ID: %', admin_user_id;
