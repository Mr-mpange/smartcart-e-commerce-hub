...
async function test() {
  ...
  try {
    ...
    console.log(`1️⃣  Generated slug: ${slug}`);
    
    // Create payment link
    console.log('\n2️⃣  Creating payment link...');
    ...
    console.log('3️⃣  Payment Link Details:');
    ...
    console.log('\n4️⃣  Fetching payment link by slug...');
    ...
    console.log('\n6️⃣  Simulating payment confirmation...');
